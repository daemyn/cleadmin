                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" data-toggle="validator" role="form" method="POST" action="{{ route('licences.update', $licence) }}">
                            ...
                            <div class="form-group{{ $errors->has('code_naf') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="code_naf" type="text" class="form-control" name="code_naf" value="{{ $licence->code_naf }}">
                            ...
                            <div class="form-group{{ $errors->has('numero_tva') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="numero_tva" type="text" class="form-control" name="numero_tva" value="{{$licence->numero_tva }}">
                            ...
                            <div class="form-group{{ $errors->has('telephone') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="telephone" type="text" class="form-control" name="telephone" value="{{ $licence->telephone }}">
                            ...
                            <div class="form-group{{ $errors->has('adresse') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="adresse" type="text" class="form-control" name="adresse" value="{{ $licence->adresse }}">
                            ...
                            <div class="form-group{{ $errors->has('code_postal') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="code_postal" type="text" class="form-control" name="code_postal" value="{{ $licence->code_postal }}">
                            ...
                            <div class="form-group{{ $errors->has('ville') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="siret" type="text" class="form-control" name="ville" value="{{$licence->ville }}">
                            ...
                            <div class="form-group{{ $errors->has('pays') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="pays" type="text" class="form-control" name="pays" value="{{ $licence->pays }}">
